...
# Output
my_output <- paste("results/busco/all_summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('Pnodorum_SN15', 'Pnodorum_SN15', 'Pnodorum_SN15', 'Pnodorum_SN15', 'Ptritici_repentis_Pt1CBF', 'Ptritici_repentis_Pt1CBF', 'Ptritici_repentis_Pt1CBF', 'Ptritici_repentis_Pt1CBF', 'Bsorokiniana_ND90Pr', 'Bsorokiniana_ND90Pr', 'Bsorokiniana_ND90Pr', 'Bsorokiniana_ND90Pr')
...
my_percentage <- c(96.7, 0.0, 1.5, 1.8, 97.8, 0.3, 0.5, 1.4, 98.4, 0.0, 0.4, 1.2)
my_values <- c(733, 0, 11, 14, 741, 2, 4, 11, 746, 0, 3, 9)
